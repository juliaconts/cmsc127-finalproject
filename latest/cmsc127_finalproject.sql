...
CREATE TABLE `alumni` (
  ...
  `yearGraduated` varchar(9) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `alumni` (`alumniID`, `studentID`, `yearGraduated`) VALUES
(1, 201799001, ''),
(2, 201799018, '');
...
(1, '2024-2025', 17, 202101829, 'Shiftee', 2, 214748364, 'Iloilo'),
(1, '2024-2025', 17, 202300102, 'Transferee', 2, 214748364, 'Iloilo'),
(1, '2024-2025', 17, 202309989, 'Regular', 2, 214748364, ''),
(1, '2024-2025', 17, 202350056, 'Irregular', 2, 214748364, ''),
(1, '2025-2026', 17, 202101829, 'Shiftee', 3, 214748364, 'Iloilo'),
(1, '2025-2026', 17, 202300102, 'Transferee', 3, 214748364, 'Iloilo'),
(1, '2025-2026', 17, 202309989, 'Regular', 3, 214748364, ''),
(1, '2025-2026', 17, 202350056, 'Irregular', 3, 214748364, ''),
...
INSERT INTO `form5` (`acadYear`, `semester`, `studentID`, `form5`) VALUES
('2023-2024', 2, 201799001, NULL),
('2023-2024', 2, 201799018, NULL),
('2023-2024', 2, 202101829, NULL),
('2023-2024', 2, 202300102, 'https://docs.google.com/spreadsheets/d/1IbPbL6lmFFrFSHwCf96ecVwpHt6ef_rYOPfMHzVwB7M/edit?usp=sharing'),
('2023-2024', 2, 202309989, NULL),
...
--
ALTER TABLE `form5`
  ADD PRIMARY KEY (`acadYear`,`semester`,`studentID`),
  ADD KEY `fk_form5_member` (`studentID`);
